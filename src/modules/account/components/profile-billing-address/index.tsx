      ...
      >
        <div className="grid grid-cols-1 gap-y-2">
          <div className="grid grid-cols-2 gap-x-2">
            <label className="text-base-semi">First name</label>
            <Input
              label="First name"
              ...
              errors={errors}
            />
            <label className="text-base-semi">Last name</label>
            <Input
              label="Last name"
          ...
          <label className="text-base-semi">Company</label>
          <Input
            label="Company"
            ...
            errors={errors}
          />
          <label className="text-base-semi">Address</label>
          <Input
            label="Address"
            ...
            errors={errors}
          />
          <label className="text-base-semi">Apartment, suite, etc.</label>
          <Input
          ...
          <div className="grid grid-cols-[144px_1fr] gap-x-2">
            <label className="text-base-semi">Postal code</label>
            <Input
              label="Postal code"
              ...
              errors={errors}
            />
            <label className="text-base-semi">City</label>
            <Input
              label="City"
          ...
          <label className="text-base-semi">Province</label>
          <Input
            label="Province"
            ...
            errors={errors}
          />
          <label className="text-base-semi">Choose country</label>
          <NativeSelect
